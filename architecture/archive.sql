...
CREATE INDEX ON "email_notifications" ("user_id");

CREATE INDEX ON "email_notifications" ("status");

CREATE INDEX ON "email_notifications" ("type");

CREATE UNIQUE INDEX ON "email_preferences" ("user_id");
...
ALTER TABLE "email_notifications" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "email_preferences" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;
