  ...
  const cheatsheets = [
    {
      ...
      description:
        "Quick reference for Go syntax, data structures, and common patterns",
    ...
    },
    {
      ...
      description:
        "Essential kubectl commands and Kubernetes resource management",
      category: "DevOps",
    ...
    },
    {
      ...
      description:
        "Docker commands, Dockerfile best practices, and container management",
      category: "DevOps",
      tags: ["Docker", "DevOps"],
      readTime: "6 min",
      downloads: 15200,
    ...
    },
    {
      ...
      description:
        "Comprehensive guide to AWS services, pricing, and use cases",
      category: "Cloud",
      tags: ["AWS", "Cloud"],
      readTime: "12 min",
      downloads: 10300,
    ...
    },
    {
      ...
      description:
        "SQL syntax, joins, aggregations, and optimization techniques",
      category: "Database",
      tags: ["SQL", "Database"],
      readTime: "10 min",
      downloads: 13400,
    ...
    },
    {
      ...
      description:
        "Essential Linux commands, file operations, and system administration",
      category: "Tools",
      tags: ["Linux", "Tools"],
      readTime: "9 min",
      downloads: 11200,
    ...
    },
    {
      ...
      description:
        "Python syntax, data structures, and standard library essentials",
      category: "Programming",
              ...
              <div className="absolute inset-x-0 bottom-0 bg-card border-t-2 border-border dark:border-input rounded-t-2xl shadow-2xl max-h-[70vh] overflow-y-auto">
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <button
                          ...
                          className={`w-full text-left px-3 py-2.5 rounded-lg text-sm font-bold transition-all border-2 flex items-center gap-2 ${
                            sortBy === option.value
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    >
                      Show {filteredCheatsheets.length} Result
          ...
          <main className="flex-1">
            <div className="mb-3 flex items-center justify-between">
              <p className="text-xs font-bold text-foreground">
                {filteredCheatsheets.length} Cheatsheet
                {filteredCheatsheets.length !== 1 ? "s" : ""}
              </p>
            </div>
