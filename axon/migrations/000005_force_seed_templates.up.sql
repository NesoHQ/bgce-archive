-- Force re-run migration 4 by deleting its record and re-inserting templates
DELETE FROM axon_schema_migrations WHERE version = 4;

-- Also clear any existing templates to avoid conflicts
